...
[![Build Status](https://img.shields.io/github/actions/workflow/status/yourusername/statemachine-rust/build.yml?branch=main)](https://github.com/yourusername/statemachine-rust/actions)
